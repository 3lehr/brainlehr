...
```
python3 wiederherstellung.py pruefe brainlehr.db.bak-20260805T230122
```
...
```
python3 wiederherstellung.py stelle_her brainlehr.db.bak-20260805T230122 --ziel /tmp/wiederhergestellt.db
```
