...
Repo `github.com/3lehr/brainlehr`, **PRIVATE**, Entscheidung `d6f0dd0f`: nie oeffentlich schalten, `brainlehr.db` liegt in 31 Commits der Historie. Eine Veroeffentlichung entsteht als NEUES Repo mit frischer Historie.
...
Testlauf im Arbeitsbaum: 646 gruen, 11 rot — dieselben elf (fehlende `brainlehr.db` im Arbeitsbaum, Umlautfaltung, instructions).
