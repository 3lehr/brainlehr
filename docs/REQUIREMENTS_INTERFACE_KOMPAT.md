...
| INT-SNAP-001 | Snapshotgrenze (`cb24f119`) | Brainlehr | Abruf/Prüfkorpus | Ein Lauf liest einen festgehaltenen Stand, nicht bei jedem Aufruf die gegenwärtige DB. **Mechanismus gebaut** (`kern/schnappschuss.py`, `festhalten()`/`lesen()`, Online-Backup-API), **nicht verdrahtet** — kein Messlauf benutzt ihn bisher. | TEST-INT-SNAP-001 |
