...
def test_source_backfill_laesst_updated_at_unveraendert(temp_db):
    ...
    conn.execute(
        ...
        "source, created_at, updated_at, anlass, norm_entscheidung, norm_entschieden_von, norm_entschieden_grund) "
        "VALUES ('n1', '/x', 'shared', 'Titel', 'Summary', 'Inhalt', 0, '', ?, ?, 'unbekannt', 'keine_norm', 'skript:test', 'Testvorrichtung')",
