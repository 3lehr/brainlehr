...
MODULE = [
    ...
    "kern/ausloeser.py",
    "kern/gegenstand.py",
    "kern/gegenstand_plankennungen.py",  # P16 Erstanwendung, 2026-08-21
    "kern/planstatus.py",
    ...
    "melder/forderung_vorgang.py",  # Strang F, Auftrag 2026-08-21
    # Gesamtbau A-G, 2026-08-21 -- von test_kein_modul_faellt_durch_die_liste
    # selbst gefunden, nicht von Hand gepflegt.
    "kern/betriebsprofil.py",
    "kern/einrichtung.py",
    "kern/verfallsrate.py",
    "melder/einbettungsaussetzer.py",
    "melder/zugriffsmuster.py",
    ...
    "melder/quelle_gegen_betrieb.py",  # Pruefgattung Quelle gegen Betrieb, L-600726, 2026-08-20
    "melder/faelligkeit.py",  # Faelligkeitskanal neben der Aehnlichkeit, 2026-08-20
    "melder/agentenbehauptung.py",  # Mechanismus zu L-706807, 2026-08-20
    "melder/nulllinie.py",  # Mechanismus zu L-871c8a, 2026-08-20
    "melder/fremdbaum_cd.py",  # Mechanismus zu L-bdfeef, 2026-08-20
    "tool/sicherer_commit.py",  # baulicher Ersatz fuer L-5e40a7, 2026-08-20
    "tool/aussenabgleich.py",  # Code-Abgleich zum weitergebbaren Klon, 2026-08-20
    "melder/unbelegter_eingang.py",  # Mechanismus zu L-bbd7fb, 2026-08-20
