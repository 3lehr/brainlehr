...
RECHTE: dict[str, str] = {
    ...
    "project_actor_boundary": "wissen:lesen",
    "project_commit_gate": "wissen:lesen",
    "project_runtime_evidence": "wissen:lesen",
    "edit_batch_complete": "wissen:lesen",
    ...
    "project_attach": "wissen:schreiben",
    "project_detach": "wissen:schreiben",
